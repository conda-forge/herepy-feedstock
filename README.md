...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/herepy-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=11966&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/herepy-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `herepy` can be installed with:

```
conda install herepy
```

It is possible to list all of the versions of `herepy` available on your platform with:
